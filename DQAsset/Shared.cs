...
namespace DQAsset
{
    ...
    {
        static uint[] CRCTable_DEPRECATED =
        {
        ...
        public static uint UE4Strihash_DEPRECATED(string str)
        {
            uint Hash = 0;
        ...
        public static string ReadFString(this BinaryReader reader)
        {
            ...
            Array.Resize(ref data, unicode ? size - 2 : size - 1); // remove null terminator
